...
tree_item_set_button_description :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_button_description_method_ptr, &self, raw_data(args), nil)
}
...
tree_item_init :: proc "contextless" () {
    ...
    __set_description_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 501894301)
    __name = new_string_name_cstring("get_description", true)
    __get_description_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 844755477)
    ...
    __add_button_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 973481897)
    ...
    __name = new_string_name_cstring("set_button_description", true)
    __set_button_description_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2285447957)
...
@(private = "file")
__set_button_description_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
