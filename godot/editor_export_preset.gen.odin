...
editor_export_preset_get_project_setting :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_project_setting_method_ptr, &self, raw_data(args), &ret)
    return
}
...
editor_export_preset_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("get_project_setting", true)
    __get_project_setting_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2138907829)
...
@(private = "file")
__get_project_setting_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
