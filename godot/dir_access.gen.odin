...
dir_access_get_filesystem_type :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_filesystem_type_method_ptr, &self, raw_data(args), &ret)
    return
}
...
dir_access_is_equivalent :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__is_equivalent_method_ptr, &self, raw_data(args), &ret)
    return
}
...
dir_access_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("get_filesystem_type", true)
    __get_filesystem_type_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 201670096)
    ...
    __name = new_string_name_cstring("is_equivalent", true)
    __is_equivalent_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 820780508)
...
@(private = "file")
__get_filesystem_type_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__is_case_sensitive_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__is_equivalent_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
