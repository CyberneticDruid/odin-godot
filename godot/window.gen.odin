...
window_get_focused_window :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_focused_window_method_ptr, nil, raw_data(args), &ret)
    return
}
...
window_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("get_focused_window", true)
    __get_focused_window_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1835468782)
}
...
@(private = "file")
__get_focused_window_method_ptr: __bindgen_gde.MethodBindPtr