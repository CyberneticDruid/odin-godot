...
camera_server_set_monitoring_feeds :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_monitoring_feeds_method_ptr, &self, raw_data(args), nil)
}
...
camera_server_is_monitoring_feeds :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__is_monitoring_feeds_method_ptr, &self, raw_data(args), &ret)
    return
}
...
camera_server_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_monitoring_feeds", true)
    __set_monitoring_feeds_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2586408642)
    __name = new_string_name_cstring("is_monitoring_feeds", true)
    __is_monitoring_feeds_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 36873697)
...
@(private = "file")
__set_monitoring_feeds_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__is_monitoring_feeds_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
