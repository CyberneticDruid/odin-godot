...
visible_on_screen_notifier2d_set_show_rect :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_show_rect_method_ptr, &self, raw_data(args), nil)
}
...
visible_on_screen_notifier2d_is_showing_rect :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__is_showing_rect_method_ptr, &self, raw_data(args), &ret)
    return
}
...
visible_on_screen_notifier2d_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_show_rect", true)
    __set_show_rect_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2586408642)
    __name = new_string_name_cstring("is_showing_rect", true)
    __is_showing_rect_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 36873697)
...
@(private = "file")
__set_show_rect_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__is_showing_rect_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
