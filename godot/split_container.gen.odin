...
split_container_set_touch_dragger_enabled :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_touch_dragger_enabled_method_ptr, &self, raw_data(args), nil)
}
...
split_container_is_touch_dragger_enabled :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__is_touch_dragger_enabled_method_ptr, &self, raw_data(args), &ret)
    return
}
...
split_container_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_touch_dragger_enabled", true)
    __set_touch_dragger_enabled_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2586408642)
    __name = new_string_name_cstring("is_touch_dragger_enabled", true)
    __is_touch_dragger_enabled_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 36873697)
}
...
@(private = "file")
__set_touch_dragger_enabled_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__is_touch_dragger_enabled_method_ptr: __bindgen_gde.MethodBindPtr