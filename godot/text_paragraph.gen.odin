...
text_paragraph_get_inferred_direction :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_inferred_direction_method_ptr, &self, raw_data(args), &ret)
    return
}
...
text_paragraph_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("get_inferred_direction", true)
    __get_inferred_direction_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2516697328)
    ...
    __get_range_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3690982128)
    ...
    __draw_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1492808103)
    __name = new_string_name_cstring("draw_outline", true)
    __draw_outline_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3820500590)
    __name = new_string_name_cstring("draw_line", true)
    __draw_line_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 828033758)
    __name = new_string_name_cstring("draw_line_outline", true)
    __draw_line_outline_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2822696703)
    __name = new_string_name_cstring("draw_dropcap", true)
    __draw_dropcap_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3625105422)
    __name = new_string_name_cstring("draw_dropcap_outline", true)
    __draw_dropcap_outline_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2592177763)
...
@(private = "file")
__get_inferred_direction_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
