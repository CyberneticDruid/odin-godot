...
path3d_set_debug_custom_color :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_debug_custom_color_method_ptr, &self, raw_data(args), nil)
}
...
path3d_get_debug_custom_color :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_debug_custom_color_method_ptr, &self, raw_data(args), &ret)
    return
}
...
path3d_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_debug_custom_color", true)
    __set_debug_custom_color_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2920490490)
    __name = new_string_name_cstring("get_debug_custom_color", true)
    __get_debug_custom_color_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3444240500)
}
...
@(private = "file")
__set_debug_custom_color_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_debug_custom_color_method_ptr: __bindgen_gde.MethodBindPtr