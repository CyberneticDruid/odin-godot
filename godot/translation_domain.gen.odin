...
translation_domain_get_locale_override :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_locale_override_method_ptr, &self, raw_data(args), &ret)
    return
}
...
translation_domain_set_locale_override :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_locale_override_method_ptr, &self, raw_data(args), nil)
}
...
translation_domain_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("get_locale_override", true)
    __get_locale_override_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 201670096)
    __name = new_string_name_cstring("set_locale_override", true)
    __set_locale_override_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 83702148)
...
@(private = "file")
__get_locale_override_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__set_locale_override_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
