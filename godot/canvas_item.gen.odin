...
canvas_item_init :: proc "contextless" () {
    ...
    __draw_string_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 719605945)
    __name = new_string_name_cstring("draw_multiline_string", true)
    __draw_multiline_string_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2341488182)
    __name = new_string_name_cstring("draw_string_outline", true)
    __draw_string_outline_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 707403449)
    __name = new_string_name_cstring("draw_multiline_string_outline", true)
    __draw_multiline_string_outline_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3050414441)
    __name = new_string_name_cstring("draw_char", true)
    __draw_char_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1336210142)
    __name = new_string_name_cstring("draw_char_outline", true)
    __draw_char_outline_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1846384149)
