...
resource_uid_uid_to_path :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__uid_to_path_method_ptr, nil, raw_data(args), &ret)
    return
}
...
resource_uid_path_to_uid :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__path_to_uid_method_ptr, nil, raw_data(args), &ret)
    return
}
...
resource_uid_ensure_path :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__ensure_path_method_ptr, nil, raw_data(args), &ret)
    return
}
...
resource_uid_create_id_for_path :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__create_id_for_path_method_ptr, &self, raw_data(args), &ret)
    return
}
...
resource_uid_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("create_id_for_path", true)
    __create_id_for_path_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1597066294)
    ...
    __name = new_string_name_cstring("uid_to_path", true)
    __uid_to_path_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1703090593)
    __name = new_string_name_cstring("path_to_uid", true)
    __path_to_uid_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1703090593)
    __name = new_string_name_cstring("ensure_path", true)
    __ensure_path_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1703090593)
}
...
@(private = "file")
__create_id_for_path_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__uid_to_path_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__path_to_uid_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__ensure_path_method_ptr: __bindgen_gde.MethodBindPtr