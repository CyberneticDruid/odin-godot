...
os_open_with_program :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__open_with_program_method_ptr, &self, raw_data(args), &ret)
    return
}
...
os_add_logger :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__add_logger_method_ptr, &self, raw_data(args), nil)
}
...
os_remove_logger :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__remove_logger_method_ptr, &self, raw_data(args), nil)
}
...
os_init :: proc "contextless" () {
    ...
    __read_string_from_stdin_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 723587915)
    __name = new_string_name_cstring("read_buffer_from_stdin", true)
    __read_buffer_from_stdin_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3249455752)
    ...
    __name = new_string_name_cstring("open_with_program", true)
    __open_with_program_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2848259907)
    ...
    __name = new_string_name_cstring("add_logger", true)
    __add_logger_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 4261188958)
    __name = new_string_name_cstring("remove_logger", true)
    __remove_logger_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 4261188958)
}
...
@(private = "file")
__open_with_program_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__add_logger_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__remove_logger_method_ptr: __bindgen_gde.MethodBindPtr