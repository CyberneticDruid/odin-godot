...
project_settings_get_setting_with_override_and_custom_features :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_setting_with_override_and_custom_features_method_ptr, &self, raw_data(args), &ret)
    return
}
...
project_settings_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("get_setting_with_override_and_custom_features", true)
    __get_setting_with_override_and_custom_features_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2434817427)
...
@(private = "file")
__get_setting_with_override_and_custom_features_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
