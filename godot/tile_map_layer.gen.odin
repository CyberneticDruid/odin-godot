...
tile_map_layer_set_physics_quadrant_size :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_physics_quadrant_size_method_ptr, &self, raw_data(args), nil)
}
...
tile_map_layer_get_physics_quadrant_size :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_physics_quadrant_size_method_ptr, &self, raw_data(args), &ret)
    return
}
...
tile_map_layer_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_physics_quadrant_size", true)
    __set_physics_quadrant_size_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1286410249)
    __name = new_string_name_cstring("get_physics_quadrant_size", true)
    __get_physics_quadrant_size_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3905245786)
...
@(private = "file")
__set_physics_quadrant_size_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_physics_quadrant_size_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
