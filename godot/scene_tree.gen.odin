...
scene_tree_is_accessibility_enabled :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__is_accessibility_enabled_method_ptr, &self, raw_data(args), &ret)
    return
}
...
scene_tree_is_accessibility_supported :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__is_accessibility_supported_method_ptr, &self, raw_data(args), &ret)
    return
}
...
scene_tree_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("is_accessibility_enabled", true)
    __is_accessibility_enabled_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 36873697)
    __name = new_string_name_cstring("is_accessibility_supported", true)
    __is_accessibility_supported_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 36873697)
...
@(private = "file")
__is_accessibility_enabled_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__is_accessibility_supported_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
