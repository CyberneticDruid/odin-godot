...
graph_edit_get_connection_list_from_node :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_connection_list_from_node_method_ptr, &self, raw_data(args), &ret)
    return
}
...
graph_edit_set_type_names :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_type_names_method_ptr, &self, raw_data(args), nil)
}
...
graph_edit_get_type_names :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_type_names_method_ptr, &self, raw_data(args), &ret)
    return
}
...
graph_edit_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("get_connection_list_from_node", true)
    __get_connection_list_from_node_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3147814860)
    ...
    __name = new_string_name_cstring("set_type_names", true)
    __set_type_names_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 4155329257)
    __name = new_string_name_cstring("get_type_names", true)
    __get_type_names_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3102165223)
...
@(private = "file")
__get_connection_list_from_node_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__set_type_names_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_type_names_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
