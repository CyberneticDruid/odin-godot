...
worker_thread_pool_get_caller_task_id :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_caller_task_id_method_ptr, &self, raw_data(args), &ret)
    return
}
...
worker_thread_pool_get_caller_group_id :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_caller_group_id_method_ptr, &self, raw_data(args), &ret)
    return
}
...
worker_thread_pool_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("get_caller_task_id", true)
    __get_caller_task_id_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3905245786)
    ...
    __name = new_string_name_cstring("get_caller_group_id", true)
    __get_caller_group_id_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3905245786)
}
...
@(private = "file")
__get_caller_task_id_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__get_caller_group_id_method_ptr: __bindgen_gde.MethodBindPtr