...
a_star2d__filter_neighbor :: proc "contextless" (
    self: A_Star2d,
    from_id_: Int,
    neighbor_id_: Int,
) -> (ret: Bool) {
    ...
    __bindgen_gde.object_method_bind_ptrcall(___filter_neighbor_method_ptr, &self, raw_data(args), &ret)
    return
}
...
a_star2d_set_neighbor_filter_enabled :: proc "contextless" (
    self: A_Star2d,
    enabled_: Bool,
) {
    self := self
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_neighbor_filter_enabled_method_ptr, &self, raw_data(args), nil)
}

a_star2d_is_neighbor_filter_enabled :: proc "contextless" (
    self: A_Star2d,
) -> (ret: Bool) {
    self := self
    args := []__bindgen_gde.TypePtr {
    }
    __bindgen_gde.object_method_bind_ptrcall(__is_neighbor_filter_enabled_method_ptr, &self, raw_data(args), &ret)
    return
}
...
a_star2d_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("_filter_neighbor", true)
    ___filter_neighbor_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2522259332)
    ...
    __name = new_string_name_cstring("set_neighbor_filter_enabled", true)
    __set_neighbor_filter_enabled_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2586408642)
    __name = new_string_name_cstring("is_neighbor_filter_enabled", true)
    __is_neighbor_filter_enabled_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 36873697)
...
@(private = "file")
___filter_neighbor_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__set_neighbor_filter_enabled_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__is_neighbor_filter_enabled_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
