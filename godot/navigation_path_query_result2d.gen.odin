...
navigation_path_query_result2d_set_path_length :: proc "contextless" (
    self: Navigation_Path_Query_Result2d,
    length_: f32,
) {
    self := self
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_path_length_method_ptr, &self, raw_data(args), nil)
}

navigation_path_query_result2d_get_path_length :: proc "contextless" (
    self: Navigation_Path_Query_Result2d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_path_query_result2d_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_path_length", true)
    __set_path_length_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 373806689)
...
@(private = "file")
__set_path_length_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
