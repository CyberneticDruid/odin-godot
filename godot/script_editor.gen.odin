...
script_editor_clear_docs_from_script :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__clear_docs_from_script_method_ptr, &self, raw_data(args), nil)
}
...
script_editor_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("clear_docs_from_script", true)
    __clear_docs_from_script_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3657522847)
}
...
@(private = "file")
__clear_docs_from_script_method_ptr: __bindgen_gde.MethodBindPtr