...
physics_direct_body_state3d_extension__set_collision_layer :: proc "contextless" (
    self: Physics_Direct_Body_State3d_Extension,
    layer_: Int,
) {
    self := self
    ...
    __bindgen_gde.object_method_bind_ptrcall(___set_collision_layer_method_ptr, &self, raw_data(args), nil)
}

physics_direct_body_state3d_extension__get_collision_layer :: proc "contextless" (
    self: Physics_Direct_Body_State3d_Extension,
) -> (ret: u32) {
    self := self
    args := []__bindgen_gde.TypePtr {
    }
    __bindgen_gde.object_method_bind_ptrcall(___get_collision_layer_method_ptr, &self, raw_data(args), &ret)
    return
}

physics_direct_body_state3d_extension__set_collision_mask :: proc "contextless" (
    self: Physics_Direct_Body_State3d_Extension,
    mask_: Int,
) {
    self := self
    ...
    __bindgen_gde.object_method_bind_ptrcall(___set_collision_mask_method_ptr, &self, raw_data(args), nil)
}

physics_direct_body_state3d_extension__get_collision_mask :: proc "contextless" (
    self: Physics_Direct_Body_State3d_Extension,
) -> (ret: u32) {
    self := self
    args := []__bindgen_gde.TypePtr {
    }
    __bindgen_gde.object_method_bind_ptrcall(___get_collision_mask_method_ptr, &self, raw_data(args), &ret)
    return
}
...
physics_direct_body_state3d_extension_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("_set_collision_layer", true)
    ___set_collision_layer_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1286410249)
    __name = new_string_name_cstring("_get_collision_layer", true)
    ___get_collision_layer_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3905245786)
    __name = new_string_name_cstring("_set_collision_mask", true)
    ___set_collision_mask_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1286410249)
    __name = new_string_name_cstring("_get_collision_mask", true)
    ___get_collision_mask_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3905245786)
...
@(private = "file")
___set_collision_layer_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
___get_collision_layer_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
___set_collision_mask_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
___get_collision_mask_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
