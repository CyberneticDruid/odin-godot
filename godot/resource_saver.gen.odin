...
resource_saver_set_uid :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_uid_method_ptr, &self, raw_data(args), &ret)
    return
}
...
resource_saver_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_uid", true)
    __set_uid_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 993915709)
...
@(private = "file")
__set_uid_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
