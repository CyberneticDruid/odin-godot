...
skeleton_modifier3d__process_modification_with_delta :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(___process_modification_with_delta_method_ptr, &self, raw_data(args), nil)
}
...
skeleton_modifier3d__skeleton_changed :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(___skeleton_changed_method_ptr, &self, raw_data(args), nil)
}
...
skeleton_modifier3d__validate_bone_names :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(___validate_bone_names_method_ptr, &self, raw_data(args), nil)
}
...
skeleton_modifier3d_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("_process_modification_with_delta", true)
    ___process_modification_with_delta_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 373806689)
    ...
    __name = new_string_name_cstring("_skeleton_changed", true)
    ___skeleton_changed_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2926744397)
    __name = new_string_name_cstring("_validate_bone_names", true)
    ___validate_bone_names_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3218959716)
...
@(private = "file")
___process_modification_with_delta_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
___process_modification_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
___skeleton_changed_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
___validate_bone_names_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
