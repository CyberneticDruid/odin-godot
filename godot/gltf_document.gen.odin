...
Gltf_Document_Visibility_Mode :: enum {
...
gltf_document_set_fallback_image_format :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_fallback_image_format_method_ptr, &self, raw_data(args), nil)
}
...
gltf_document_get_fallback_image_format :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_fallback_image_format_method_ptr, &self, raw_data(args), &ret)
    return
}

gltf_document_set_fallback_image_quality :: proc "contextless" (
    self: Gltf_Document,
    fallback_image_quality_: f32,
) {
    self := self
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_fallback_image_quality_method_ptr, &self, raw_data(args), nil)
}
...
gltf_document_get_fallback_image_quality :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_fallback_image_quality_method_ptr, &self, raw_data(args), &ret)
    return
}
...
gltf_document_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_fallback_image_format", true)
    __set_fallback_image_format_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 83702148)
    __name = new_string_name_cstring("get_fallback_image_format", true)
    __get_fallback_image_format_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 201670096)
    __name = new_string_name_cstring("set_fallback_image_quality", true)
    __set_fallback_image_quality_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 373806689)
    __name = new_string_name_cstring("get_fallback_image_quality", true)
    __get_fallback_image_quality_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1740695150)
    ...
    __set_visibility_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2803579218)
    __name = new_string_name_cstring("get_visibility_mode", true)
    __get_visibility_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3885445962)
...
@(private = "file")
__set_fallback_image_format_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_fallback_image_format_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__set_fallback_image_quality_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_fallback_image_quality_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
