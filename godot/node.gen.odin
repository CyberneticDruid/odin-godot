...
node_get_orphan_node_ids :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_orphan_node_ids_method_ptr, nil, raw_data(args), &ret)
    return
}
...
node__get_accessibility_configuration_warnings :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(___get_accessibility_configuration_warnings_method_ptr, &self, raw_data(args), &ret)
    return
}
...
node__get_focused_accessibility_element :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(___get_focused_accessibility_element_method_ptr, &self, raw_data(args), &ret)
    return
}
...
node_queue_accessibility_update :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__queue_accessibility_update_method_ptr, &self, raw_data(args), nil)
}
...
node_get_accessibility_element :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_accessibility_element_method_ptr, &self, raw_data(args), &ret)
    return
}
...
node_can_auto_translate :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__can_auto_translate_method_ptr, &self, raw_data(args), &ret)
    return
}
...
node_get_node_rpc_config :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_node_rpc_config_method_ptr, &self, raw_data(args), &ret)
    return
}
...
node_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("_get_accessibility_configuration_warnings", true)
    ___get_accessibility_configuration_warnings_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1139954409)
    ...
    __name = new_string_name_cstring("_get_focused_accessibility_element", true)
    ___get_focused_accessibility_element_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2944877500)
    ...
    __name = new_string_name_cstring("queue_accessibility_update", true)
    __queue_accessibility_update_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3218959716)
    __name = new_string_name_cstring("get_accessibility_element", true)
    __get_accessibility_element_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2944877500)
    ...
    __name = new_string_name_cstring("can_auto_translate", true)
    __can_auto_translate_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 36873697)
    ...
    __name = new_string_name_cstring("get_node_rpc_config", true)
    __get_node_rpc_config_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1214101251)
    ...
    __name = new_string_name_cstring("get_orphan_node_ids", true)
    __get_orphan_node_ids_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2915620761)
}
...
@(private = "file")
___get_accessibility_configuration_warnings_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
___get_focused_accessibility_element_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__queue_accessibility_update_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_accessibility_element_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__can_auto_translate_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__get_node_rpc_config_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__get_orphan_node_ids_method_ptr: __bindgen_gde.MethodBindPtr