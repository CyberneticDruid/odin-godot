...
rich_text_label_add_hr :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__add_hr_method_ptr, &self, raw_data(args), nil)
}
...
rich_text_label_set_table_column_name :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_table_column_name_method_ptr, &self, raw_data(args), nil)
}
...
rich_text_label_set_autowrap_trim_flags :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_autowrap_trim_flags_method_ptr, &self, raw_data(args), nil)
}
...
rich_text_label_get_autowrap_trim_flags :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_autowrap_trim_flags_method_ptr, &self, raw_data(args), &ret)
    return
}
...
rich_text_label_set_scroll_follow_visible_characters :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_scroll_follow_visible_characters_method_ptr, &self, raw_data(args), nil)
}
...
rich_text_label_is_scroll_following_visible_characters :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__is_scroll_following_visible_characters_method_ptr, &self, raw_data(args), &ret)
    return
}
...
rich_text_label_get_visible_content_rect :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_visible_content_rect_method_ptr, &self, raw_data(args), &ret)
    return
}
...
rich_text_label_reload_effects :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__reload_effects_method_ptr, &self, raw_data(args), nil)
}
...
rich_text_label_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("add_hr", true)
    __add_hr_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 16816895)
    __name = new_string_name_cstring("add_image", true)
    __add_image_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1390915033)
    __name = new_string_name_cstring("update_image", true)
    __update_image_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 6389170)
    ...
    __push_underline_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1458098034)
    __name = new_string_name_cstring("push_strikethrough", true)
    __push_strikethrough_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1458098034)
    __name = new_string_name_cstring("push_table", true)
    __push_table_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3426862026)
    ...
    __name = new_string_name_cstring("set_table_column_name", true)
    __set_table_column_name_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 501894301)
    ...
    __name = new_string_name_cstring("set_autowrap_trim_flags", true)
    __set_autowrap_trim_flags_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2809697122)
    __name = new_string_name_cstring("get_autowrap_trim_flags", true)
    __get_autowrap_trim_flags_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2340632602)
    ...
    __name = new_string_name_cstring("set_scroll_follow_visible_characters", true)
    __set_scroll_follow_visible_characters_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2586408642)
    __name = new_string_name_cstring("is_scroll_following_visible_characters", true)
    __is_scroll_following_visible_characters_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 36873697)
    ...
    __get_line_height_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 923996154)
    __name = new_string_name_cstring("get_line_width", true)
    __get_line_width_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 923996154)
    __name = new_string_name_cstring("get_visible_content_rect", true)
    __get_visible_content_rect_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 410525958)
    ...
    __name = new_string_name_cstring("reload_effects", true)
    __reload_effects_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3218959716)
...
@(private = "file")
__add_hr_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__set_table_column_name_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__set_autowrap_trim_flags_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_autowrap_trim_flags_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__set_scroll_follow_visible_characters_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__is_scroll_following_visible_characters_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__get_visible_content_rect_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__reload_effects_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
