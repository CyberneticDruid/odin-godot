...
jsonrpc_set_method :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_method_method_ptr, &self, raw_data(args), nil)
}
...
jsonrpc_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_method", true)
    __set_method_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2137474292)
...
@(private = "file")
__set_method_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
