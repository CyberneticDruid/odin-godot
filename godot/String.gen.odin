...
string_string_replace_char :: proc "contextless" (
    self: ^String,
    key_: Int,
    with_: Int,
) -> (ret: String) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("string_replace_char", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.String, &_gde_name, 787537301)
    }
    key_ := key_
    with_ := with_
...
string_string_replace_chars :: proc "contextless" (
    self: ^String,
    keys_: String,
    with_: Int,
) -> (ret: String) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("string_replace_chars", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.String, &_gde_name, 3535100402)
    }
    keys_ := keys_
    with_ := with_
...
string_string_remove_char :: proc "contextless" (
    self: ^String,
    what_: Int,
) -> (ret: String) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("string_remove_char", true)
...
string_string_remove_chars :: proc "contextless" (
    self: ^String,
    chars_: String,
) -> (ret: String) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("string_remove_chars", true)
...
string_string_to_kebab_case :: proc "contextless" (
    self: ^String,
) -> (ret: String) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("string_to_kebab_case", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.String, &_gde_name, 3942272618)
    }
    args := []__bindgen_gde.TypePtr {
    }
...
string_string_uri_file_decode :: proc "contextless" (
    self: ^String,
) -> (ret: String) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("string_uri_file_decode", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.String, &_gde_name, 3942272618)
    }
    args := []__bindgen_gde.TypePtr {
    }
...
string_string_to_multibyte_char_buffer :: proc "contextless" (
    self: ^String,
    encoding_: String,
) -> (ret: Packed_Byte_Array) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("string_to_multibyte_char_buffer", true)
