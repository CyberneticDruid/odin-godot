...
file_access_get_access_time :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_access_time_method_ptr, nil, raw_data(args), &ret)
    return
}
...
file_access_get_size :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_size_method_ptr, nil, raw_data(args), &ret)
    return
}
...
file_access_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("get_access_time", true)
    __get_access_time_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1597066294)
    __name = new_string_name_cstring("get_size", true)
    __get_size_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1597066294)
...
@(private = "file")
__get_access_time_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
