...
theme_rename_type :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__rename_type_method_ptr, &self, raw_data(args), nil)
}
...
theme_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("rename_type", true)
    __rename_type_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3740211285)
...
@(private = "file")
__rename_type_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
