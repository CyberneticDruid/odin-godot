...
soft_body3d_set_shrinking_factor :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_shrinking_factor_method_ptr, &self, raw_data(args), nil)
}
...
soft_body3d_get_shrinking_factor :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_shrinking_factor_method_ptr, &self, raw_data(args), &ret)
    return
}
...
soft_body3d_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_shrinking_factor", true)
    __set_shrinking_factor_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 373806689)
    __name = new_string_name_cstring("get_shrinking_factor", true)
    __get_shrinking_factor_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 191475506)
    ...
    __apply_impulse_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1530502735)
    __name = new_string_name_cstring("apply_force", true)
    __apply_force_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1530502735)
...
@(private = "file")
__set_shrinking_factor_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_shrinking_factor_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
