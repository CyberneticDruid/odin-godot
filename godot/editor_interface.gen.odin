...
editor_interface_get_open_scene_roots :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_open_scene_roots_method_ptr, &self, raw_data(args), &ret)
    return
}
...
editor_interface_close_scene :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__close_scene_method_ptr, &self, raw_data(args), &ret)
    return
}
...
editor_interface_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("get_open_scene_roots", true)
    __get_open_scene_roots_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3995934104)
    ...
    __name = new_string_name_cstring("close_scene", true)
    __close_scene_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 166280745)
...
@(private = "file")
__get_open_scene_roots_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__close_scene_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
