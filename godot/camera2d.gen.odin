...
camera2d_set_limit_enabled :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_limit_enabled_method_ptr, &self, raw_data(args), nil)
}
...
camera2d_is_limit_enabled :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__is_limit_enabled_method_ptr, &self, raw_data(args), &ret)
    return
}
...
camera2d_get_screen_rotation :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_screen_rotation_method_ptr, &self, raw_data(args), &ret)
    return
}
...
camera2d_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_limit_enabled", true)
    __set_limit_enabled_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2586408642)
    __name = new_string_name_cstring("is_limit_enabled", true)
    __is_limit_enabled_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 36873697)
    ...
    __name = new_string_name_cstring("get_screen_rotation", true)
    __get_screen_rotation_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1740695150)
...
@(private = "file")
__set_limit_enabled_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__is_limit_enabled_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__get_screen_rotation_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
