...
font_init :: proc "contextless" () {
    ...
    __draw_string_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1976686372)
    __name = new_string_name_cstring("draw_multiline_string", true)
    __draw_multiline_string_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2686601589)
    __name = new_string_name_cstring("draw_string_outline", true)
    __draw_string_outline_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 701417663)
    __name = new_string_name_cstring("draw_multiline_string_outline", true)
    __draw_multiline_string_outline_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 4147839237)
    ...
    __draw_char_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3500170256)
    __name = new_string_name_cstring("draw_char_outline", true)
    __draw_char_outline_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1684114874)
