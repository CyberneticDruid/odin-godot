...
string_name_string_name_replace_char :: proc "contextless" (
    self: ^String_Name,
    key_: Int,
    with_: Int,
) -> (ret: String) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("string_name_replace_char", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.String_Name, &_gde_name, 787537301)
    }
    key_ := key_
    with_ := with_
...
string_name_string_name_replace_chars :: proc "contextless" (
    self: ^String_Name,
    keys_: String,
    with_: Int,
) -> (ret: String) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("string_name_replace_chars", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.String_Name, &_gde_name, 3535100402)
    }
    keys_ := keys_
    with_ := with_
...
string_name_string_name_remove_char :: proc "contextless" (
    self: ^String_Name,
    what_: Int,
) -> (ret: String) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("string_name_remove_char", true)
...
string_name_string_name_remove_chars :: proc "contextless" (
    self: ^String_Name,
    chars_: String,
) -> (ret: String) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("string_name_remove_chars", true)
...
string_name_string_name_to_kebab_case :: proc "contextless" (
    self: ^String_Name,
) -> (ret: String) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("string_name_to_kebab_case", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.String_Name, &_gde_name, 3942272618)
    }
    args := []__bindgen_gde.TypePtr {
    }
...
string_name_string_name_uri_file_decode :: proc "contextless" (
    self: ^String_Name,
) -> (ret: String) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("string_name_uri_file_decode", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.String_Name, &_gde_name, 3942272618)
    }
    args := []__bindgen_gde.TypePtr {
    }
...
string_name_string_name_to_multibyte_char_buffer :: proc "contextless" (
    self: ^String_Name,
    encoding_: String,
) -> (ret: Packed_Byte_Array) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("string_name_to_multibyte_char_buffer", true)
