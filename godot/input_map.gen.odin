...
input_map_get_action_description :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_action_description_method_ptr, &self, raw_data(args), &ret)
    return
}
...
input_map_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("get_action_description", true)
    __get_action_description_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 957595536)
...
@(private = "file")
__get_action_description_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
