...
line_edit_init :: proc "contextless" () {
    ...
    __get_next_composite_character_column_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 923996154)
    __name = new_string_name_cstring("get_previous_composite_character_column", true)
    __get_previous_composite_character_column_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 923996154)
