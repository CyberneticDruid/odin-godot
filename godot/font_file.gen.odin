...
font_file_set_modulate_color_glyphs :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_modulate_color_glyphs_method_ptr, &self, raw_data(args), nil)
}
...
font_file_is_modulate_color_glyphs :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__is_modulate_color_glyphs_method_ptr, &self, raw_data(args), &ret)
    return
}
...
font_file_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_modulate_color_glyphs", true)
    __set_modulate_color_glyphs_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2586408642)
    __name = new_string_name_cstring("is_modulate_color_glyphs", true)
    __is_modulate_color_glyphs_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 36873697)
...
@(private = "file")
__set_modulate_color_glyphs_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__is_modulate_color_glyphs_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
