...
open_xr_extension_wrapper__set_frame_wait_info_and_get_next_pointer :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(___set_frame_wait_info_and_get_next_pointer_method_ptr, &self, raw_data(args), &ret)
    return
}
...
open_xr_extension_wrapper__set_frame_end_info_and_get_next_pointer :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(___set_frame_end_info_and_get_next_pointer_method_ptr, &self, raw_data(args), &ret)
    return
}
...
open_xr_extension_wrapper__set_view_locate_info_and_get_next_pointer :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(___set_view_locate_info_and_get_next_pointer_method_ptr, &self, raw_data(args), &ret)
    return
}
...
open_xr_extension_wrapper__set_reference_space_create_info_and_get_next_pointer :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(___set_reference_space_create_info_and_get_next_pointer_method_ptr, &self, raw_data(args), &ret)
    return
}
...
open_xr_extension_wrapper__on_sync_actions :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(___on_sync_actions_method_ptr, &self, raw_data(args), nil)
}
...
open_xr_extension_wrapper_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("_set_frame_wait_info_and_get_next_pointer", true)
    ___set_frame_wait_info_and_get_next_pointer_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3744713108)
    __name = new_string_name_cstring("_set_frame_end_info_and_get_next_pointer", true)
    ___set_frame_end_info_and_get_next_pointer_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3744713108)
    __name = new_string_name_cstring("_set_view_locate_info_and_get_next_pointer", true)
    ___set_view_locate_info_and_get_next_pointer_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3744713108)
    __name = new_string_name_cstring("_set_reference_space_create_info_and_get_next_pointer", true)
    ___set_reference_space_create_info_and_get_next_pointer_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 50157827)
    ...
    __name = new_string_name_cstring("_on_sync_actions", true)
    ___on_sync_actions_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3218959716)
...
@(private = "file")
___set_frame_wait_info_and_get_next_pointer_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
___set_frame_end_info_and_get_next_pointer_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
___set_view_locate_info_and_get_next_pointer_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
___set_reference_space_create_info_and_get_next_pointer_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
___on_sync_actions_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
