...
audio_stream_wav_set_tags :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_tags_method_ptr, &self, raw_data(args), nil)
}
...
audio_stream_wav_get_tags :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_tags_method_ptr, &self, raw_data(args), &ret)
    return
}
...
audio_stream_wav_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_tags", true)
    __set_tags_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 4155329257)
    __name = new_string_name_cstring("get_tags", true)
    __get_tags_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3102165223)
...
@(private = "file")
__set_tags_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_tags_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
