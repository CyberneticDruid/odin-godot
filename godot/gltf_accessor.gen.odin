...
gltf_accessor_init :: proc "contextless" () {
    ...
    __get_buffer_view_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3905245786)
    ...
    __get_component_type_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 852227802)
    __name = new_string_name_cstring("set_component_type", true)
    __set_component_type_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1780020221)
    __name = new_string_name_cstring("get_normalized", true)
    __get_normalized_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 36873697)
    ...
    __get_count_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3905245786)
    ...
    __get_type_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3905245786)
    ...
    __get_min_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 547233126)
    ...
    __get_max_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 547233126)
    ...
    __get_sparse_count_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3905245786)
    ...
    __get_sparse_indices_buffer_view_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3905245786)
    ...
    __get_sparse_indices_byte_offset_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3905245786)
    ...
    __get_sparse_indices_component_type_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 852227802)
    __name = new_string_name_cstring("set_sparse_indices_component_type", true)
    __set_sparse_indices_component_type_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1780020221)
    __name = new_string_name_cstring("get_sparse_values_buffer_view", true)
    __get_sparse_values_buffer_view_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3905245786)
    ...
    __get_sparse_values_byte_offset_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3905245786)
