...
image_save_dds :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__save_dds_method_ptr, &self, raw_data(args), &ret)
    return
}
...
image_save_dds_to_buffer :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__save_dds_to_buffer_method_ptr, &self, raw_data(args), &ret)
    return
}
...
image_load_dds_from_buffer :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__load_dds_from_buffer_method_ptr, &self, raw_data(args), &ret)
    return
}
...
image_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("save_dds", true)
    __save_dds_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2113323047)
    __name = new_string_name_cstring("save_dds_to_buffer", true)
    __save_dds_to_buffer_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2362200018)
    ...
    __name = new_string_name_cstring("load_dds_from_buffer", true)
    __load_dds_from_buffer_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 680677267)
...
@(private = "file")
__save_dds_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__save_dds_to_buffer_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__load_dds_from_buffer_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
