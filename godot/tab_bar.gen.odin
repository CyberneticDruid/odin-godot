...
tab_bar_set_close_with_middle_mouse :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_close_with_middle_mouse_method_ptr, &self, raw_data(args), nil)
}
...
tab_bar_get_close_with_middle_mouse :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_close_with_middle_mouse_method_ptr, &self, raw_data(args), &ret)
    return
}
...
tab_bar_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_close_with_middle_mouse", true)
    __set_close_with_middle_mouse_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2586408642)
    __name = new_string_name_cstring("get_close_with_middle_mouse", true)
    __get_close_with_middle_mouse_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 36873697)
...
@(private = "file")
__set_close_with_middle_mouse_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_close_with_middle_mouse_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
