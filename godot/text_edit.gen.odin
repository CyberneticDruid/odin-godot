...
text_edit_set_tab_input_mode :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_tab_input_mode_method_ptr, &self, raw_data(args), nil)
}
...
text_edit_get_tab_input_mode :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_tab_input_mode_method_ptr, &self, raw_data(args), &ret)
    return
}
...
text_edit_set_backspace_deletes_composite_character_enabled :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_backspace_deletes_composite_character_enabled_method_ptr, &self, raw_data(args), nil)
}
...
text_edit_is_backspace_deletes_composite_character_enabled :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__is_backspace_deletes_composite_character_enabled_method_ptr, &self, raw_data(args), &ret)
    return
}
...
text_edit_set_virtual_keyboard_show_on_focus :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_virtual_keyboard_show_on_focus_method_ptr, &self, raw_data(args), nil)
}
...
text_edit_get_virtual_keyboard_show_on_focus :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_virtual_keyboard_show_on_focus_method_ptr, &self, raw_data(args), &ret)
    return
}
...
text_edit_get_next_composite_character_column :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_next_composite_character_column_method_ptr, &self, raw_data(args), &ret)
    return
}
...
text_edit_get_previous_composite_character_column :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_previous_composite_character_column_method_ptr, &self, raw_data(args), &ret)
    return
}
...
text_edit_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_tab_input_mode", true)
    __set_tab_input_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2586408642)
    __name = new_string_name_cstring("get_tab_input_mode", true)
    __get_tab_input_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 36873697)
    ...
    __name = new_string_name_cstring("set_backspace_deletes_composite_character_enabled", true)
    __set_backspace_deletes_composite_character_enabled_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2586408642)
    __name = new_string_name_cstring("is_backspace_deletes_composite_character_enabled", true)
    __is_backspace_deletes_composite_character_enabled_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 36873697)
    ...
    __name = new_string_name_cstring("set_virtual_keyboard_show_on_focus", true)
    __set_virtual_keyboard_show_on_focus_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2586408642)
    __name = new_string_name_cstring("get_virtual_keyboard_show_on_focus", true)
    __get_virtual_keyboard_show_on_focus_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 36873697)
    ...
    __name = new_string_name_cstring("get_next_composite_character_column", true)
    __get_next_composite_character_column_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3175239445)
    __name = new_string_name_cstring("get_previous_composite_character_column", true)
    __get_previous_composite_character_column_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3175239445)
...
@(private = "file")
__set_tab_input_mode_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_tab_input_mode_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__set_backspace_deletes_composite_character_enabled_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__is_backspace_deletes_composite_character_enabled_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__set_virtual_keyboard_show_on_focus_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_virtual_keyboard_show_on_focus_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__get_next_composite_character_column_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_previous_composite_character_column_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
