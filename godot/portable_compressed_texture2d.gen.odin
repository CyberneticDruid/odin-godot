...
portable_compressed_texture2d_set_basisu_compressor_params :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_basisu_compressor_params_method_ptr, &self, raw_data(args), nil)
}
...
portable_compressed_texture2d_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_basisu_compressor_params", true)
    __set_basisu_compressor_params_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1602489585)
...
@(private = "file")
__set_basisu_compressor_params_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
