...
open_xrapi_extension_set_custom_play_space :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_custom_play_space_method_ptr, &self, raw_data(args), nil)
}
...
open_xrapi_extension_register_frame_info_extension :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__register_frame_info_extension_method_ptr, &self, raw_data(args), nil)
}
...
open_xrapi_extension_unregister_frame_info_extension :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__unregister_frame_info_extension_method_ptr, &self, raw_data(args), nil)
}
...
open_xrapi_extension_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_custom_play_space", true)
    __set_custom_play_space_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1286410249)
    ...
    __register_composition_layer_provider_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1477360496)
    __name = new_string_name_cstring("unregister_composition_layer_provider", true)
    __unregister_composition_layer_provider_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1477360496)
    __name = new_string_name_cstring("register_projection_views_extension", true)
    __register_projection_views_extension_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1477360496)
    __name = new_string_name_cstring("unregister_projection_views_extension", true)
    __unregister_projection_views_extension_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1477360496)
    __name = new_string_name_cstring("register_frame_info_extension", true)
    __register_frame_info_extension_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1477360496)
    __name = new_string_name_cstring("unregister_frame_info_extension", true)
    __unregister_frame_info_extension_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1477360496)
...
@(private = "file")
__set_custom_play_space_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__register_frame_info_extension_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__unregister_frame_info_extension_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
