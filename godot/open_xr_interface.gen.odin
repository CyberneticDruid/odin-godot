...
Open_Xr_Interface_Session_State :: enum {
...
Open_Xr_Interface_Perf_Settings_Level :: enum {
...
open_xr_interface_get_session_state :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_session_state_method_ptr, &self, raw_data(args), &ret)
    return
}
...
open_xr_interface_set_cpu_level :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_cpu_level_method_ptr, &self, raw_data(args), nil)
}
...
open_xr_interface_set_gpu_level :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_gpu_level_method_ptr, &self, raw_data(args), nil)
}
...
open_xr_interface_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("get_session_state", true)
    __get_session_state_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 896364779)
    ...
    __name = new_string_name_cstring("set_cpu_level", true)
    __set_cpu_level_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2940842095)
    __name = new_string_name_cstring("set_gpu_level", true)
    __set_gpu_level_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2940842095)
}
...
@(private = "file")
__get_session_state_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__set_cpu_level_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__set_gpu_level_method_ptr: __bindgen_gde.MethodBindPtr