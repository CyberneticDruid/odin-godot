...
navigation_server3d_region_get_iteration_id :: proc "contextless" (
    self: Navigation_Server3d,
    region_: Rid,
) -> (ret: u32) {
    self := self
    ...
    __bindgen_gde.object_method_bind_ptrcall(__region_get_iteration_id_method_ptr, &self, raw_data(args), &ret)
    return
}

navigation_server3d_region_set_use_async_iterations :: proc "contextless" (
    self: Navigation_Server3d,
    region_: Rid,
    enabled_: Bool,
) {
    ...
    __bindgen_gde.object_method_bind_ptrcall(__region_set_use_async_iterations_method_ptr, &self, raw_data(args), nil)
}

navigation_server3d_region_get_use_async_iterations :: proc "contextless" (
    self: Navigation_Server3d,
    region_: Rid,
) -> (ret: Bool) {
    self := self
    ...
    __bindgen_gde.object_method_bind_ptrcall(__region_get_use_async_iterations_method_ptr, &self, raw_data(args), &ret)
    return
}
...
navigation_server3d_link_get_iteration_id :: proc "contextless" (
    self: Navigation_Server3d,
    link_: Rid,
) -> (ret: u32) {
    self := self
    ...
    __bindgen_gde.object_method_bind_ptrcall(__link_get_iteration_id_method_ptr, &self, raw_data(args), &ret)
    return
}
...
navigation_server3d_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("region_get_iteration_id", true)
    __region_get_iteration_id_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2198884583)
    __name = new_string_name_cstring("region_set_use_async_iterations", true)
    __region_set_use_async_iterations_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1265174801)
    __name = new_string_name_cstring("region_get_use_async_iterations", true)
    __region_get_use_async_iterations_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 4155700596)
    ...
    __name = new_string_name_cstring("link_get_iteration_id", true)
    __link_get_iteration_id_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2198884583)
...
@(private = "file")
__region_get_iteration_id_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__region_set_use_async_iterations_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__region_get_use_async_iterations_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__link_get_iteration_id_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
