...
spring_bone_simulator3d_set_rotation_axis_vector :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_rotation_axis_vector_method_ptr, &self, raw_data(args), nil)
}
...
spring_bone_simulator3d_get_rotation_axis_vector :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_rotation_axis_vector_method_ptr, &self, raw_data(args), &ret)
    return
}
...
spring_bone_simulator3d_set_joint_rotation_axis_vector :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_joint_rotation_axis_vector_method_ptr, &self, raw_data(args), nil)
}
...
spring_bone_simulator3d_get_joint_rotation_axis_vector :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_joint_rotation_axis_vector_method_ptr, &self, raw_data(args), &ret)
    return
}
...
spring_bone_simulator3d_set_external_force :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_external_force_method_ptr, &self, raw_data(args), nil)
}
...
spring_bone_simulator3d_get_external_force :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_external_force_method_ptr, &self, raw_data(args), &ret)
    return
}
...
spring_bone_simulator3d_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_rotation_axis_vector", true)
    __set_rotation_axis_vector_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1530502735)
    __name = new_string_name_cstring("get_rotation_axis_vector", true)
    __get_rotation_axis_vector_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 711720468)
    ...
    __name = new_string_name_cstring("set_joint_rotation_axis_vector", true)
    __set_joint_rotation_axis_vector_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2866752138)
    __name = new_string_name_cstring("get_joint_rotation_axis_vector", true)
    __get_joint_rotation_axis_vector_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1592972041)
    ...
    __name = new_string_name_cstring("set_external_force", true)
    __set_external_force_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3460891852)
    __name = new_string_name_cstring("get_external_force", true)
    __get_external_force_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3360562783)
...
@(private = "file")
__set_rotation_axis_vector_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_rotation_axis_vector_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__set_joint_rotation_axis_vector_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_joint_rotation_axis_vector_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__set_external_force_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_external_force_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
