...
editor_export_plugin__update_android_prebuilt_manifest :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(___update_android_prebuilt_manifest_method_ptr, &self, raw_data(args), &ret)
    return
}
...
editor_export_plugin_add_apple_embedded_platform_project_static_lib :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__add_apple_embedded_platform_project_static_lib_method_ptr, &self, raw_data(args), nil)
}
...
editor_export_plugin_add_apple_embedded_platform_framework :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__add_apple_embedded_platform_framework_method_ptr, &self, raw_data(args), nil)
}
...
editor_export_plugin_add_apple_embedded_platform_embedded_framework :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__add_apple_embedded_platform_embedded_framework_method_ptr, &self, raw_data(args), nil)
}
...
editor_export_plugin_add_apple_embedded_platform_plist_content :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__add_apple_embedded_platform_plist_content_method_ptr, &self, raw_data(args), nil)
}
...
editor_export_plugin_add_apple_embedded_platform_linker_flags :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__add_apple_embedded_platform_linker_flags_method_ptr, &self, raw_data(args), nil)
}
...
editor_export_plugin_add_apple_embedded_platform_bundle_file :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__add_apple_embedded_platform_bundle_file_method_ptr, &self, raw_data(args), nil)
}
...
editor_export_plugin_add_apple_embedded_platform_cpp_code :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__add_apple_embedded_platform_cpp_code_method_ptr, &self, raw_data(args), nil)
}
...
editor_export_plugin_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("_update_android_prebuilt_manifest", true)
    ___update_android_prebuilt_manifest_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3304965187)
    ...
    __name = new_string_name_cstring("add_apple_embedded_platform_project_static_lib", true)
    __add_apple_embedded_platform_project_static_lib_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 83702148)
    __name = new_string_name_cstring("add_apple_embedded_platform_framework", true)
    __add_apple_embedded_platform_framework_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 83702148)
    __name = new_string_name_cstring("add_apple_embedded_platform_embedded_framework", true)
    __add_apple_embedded_platform_embedded_framework_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 83702148)
    __name = new_string_name_cstring("add_apple_embedded_platform_plist_content", true)
    __add_apple_embedded_platform_plist_content_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 83702148)
    __name = new_string_name_cstring("add_apple_embedded_platform_linker_flags", true)
    __add_apple_embedded_platform_linker_flags_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 83702148)
    __name = new_string_name_cstring("add_apple_embedded_platform_bundle_file", true)
    __add_apple_embedded_platform_bundle_file_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 83702148)
    __name = new_string_name_cstring("add_apple_embedded_platform_cpp_code", true)
    __add_apple_embedded_platform_cpp_code_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 83702148)
...
@(private = "file")
___update_android_prebuilt_manifest_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__add_shared_object_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__add_file_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__add_apple_embedded_platform_project_static_lib_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__add_apple_embedded_platform_framework_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__add_apple_embedded_platform_embedded_framework_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__add_apple_embedded_platform_plist_content_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__add_apple_embedded_platform_linker_flags_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__add_apple_embedded_platform_bundle_file_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__add_apple_embedded_platform_cpp_code_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
