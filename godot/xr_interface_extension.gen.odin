...
xr_interface_extension__get_vrs_texture_format :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(___get_vrs_texture_format_method_ptr, &self, raw_data(args), &ret)
    return
}
...
xr_interface_extension_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("_get_vrs_texture_format", true)
    ___get_vrs_texture_format_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1500923256)
...
@(private = "file")
___get_vrs_texture_format_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
