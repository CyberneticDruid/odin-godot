...
slider_get_ticks_position :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_ticks_position_method_ptr, &self, raw_data(args), &ret)
    return
}
...
slider_set_ticks_position :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_ticks_position_method_ptr, &self, raw_data(args), nil)
}
...
slider_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("get_ticks_position", true)
    __get_ticks_position_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3567635531)
    __name = new_string_name_cstring("set_ticks_position", true)
    __set_ticks_position_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2952822224)
...
@(private = "file")
__get_ticks_position_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__set_ticks_position_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
