...
color_picker_button_set_edit_intensity :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_edit_intensity_method_ptr, &self, raw_data(args), nil)
}
...
color_picker_button_is_editing_intensity :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__is_editing_intensity_method_ptr, &self, raw_data(args), &ret)
    return
}
...
color_picker_button_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_edit_intensity", true)
    __set_edit_intensity_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2586408642)
    __name = new_string_name_cstring("is_editing_intensity", true)
    __is_editing_intensity_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 36873697)
}
...
@(private = "file")
__set_edit_intensity_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__is_editing_intensity_method_ptr: __bindgen_gde.MethodBindPtr