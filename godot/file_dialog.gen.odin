...
File_Dialog_Display_Mode :: enum {
    Display_Thumbnails = 0,
    Display_List = 1,
}
File_Dialog_Customization :: enum {
...
file_dialog_set_customization_flag_enabled :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_customization_flag_enabled_method_ptr, &self, raw_data(args), nil)
}
...
file_dialog_is_customization_flag_enabled :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__is_customization_flag_enabled_method_ptr, &self, raw_data(args), &ret)
    return
}
...
file_dialog_init :: proc "contextless" () {
    ...
    __set_display_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2692197101)
    __name = new_string_name_cstring("get_display_mode", true)
    __get_display_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1092104624)
    ...
    __name = new_string_name_cstring("set_customization_flag_enabled", true)
    __set_customization_flag_enabled_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3849177100)
    __name = new_string_name_cstring("is_customization_flag_enabled", true)
    __is_customization_flag_enabled_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3722277863)
...
@(private = "file")
__set_customization_flag_enabled_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__is_customization_flag_enabled_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
