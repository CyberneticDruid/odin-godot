...
packed_byte_array_packed_byte_array_erase :: proc "contextless" (
    self: ^Packed_Byte_Array,
    value_: Int,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_byte_array_erase", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.Packed_Byte_Array, &_gde_name, 694024632)
    }
    value_ := value_
    args := []__bindgen_gde.TypePtr {
...
packed_byte_array_packed_byte_array_get_string_from_multibyte_char :: proc "contextless" (
    self: ^Packed_Byte_Array,
    encoding_: String,
) -> (ret: String) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_byte_array_get_string_from_multibyte_char", true)
...
packed_byte_array_packed_byte_array_to_vector2_array :: proc "contextless" (
    self: ^Packed_Byte_Array,
) -> (ret: Packed_Vector2_Array) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_byte_array_to_vector2_array", true)
...
packed_byte_array_packed_byte_array_to_vector3_array :: proc "contextless" (
    self: ^Packed_Byte_Array,
) -> (ret: Packed_Vector3_Array) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_byte_array_to_vector3_array", true)
...
packed_byte_array_packed_byte_array_to_vector4_array :: proc "contextless" (
    self: ^Packed_Byte_Array,
) -> (ret: Packed_Vector4_Array) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_byte_array_to_vector4_array", true)
...
packed_byte_array_packed_byte_array_to_color_array :: proc "contextless" (
    self: ^Packed_Byte_Array,
) -> (ret: Packed_Color_Array) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_byte_array_to_color_array", true)
...
packed_byte_array_packed_byte_array_bswap16 :: proc "contextless" (
    self: ^Packed_Byte_Array,
    offset_: Int,
    count_: Int,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_byte_array_bswap16", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.Packed_Byte_Array, &_gde_name, 3638975848)
    }
    offset_ := offset_
    count_ := count_
...
packed_byte_array_packed_byte_array_bswap32 :: proc "contextless" (
    self: ^Packed_Byte_Array,
    offset_: Int,
    count_: Int,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_byte_array_bswap32", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.Packed_Byte_Array, &_gde_name, 3638975848)
    }
    offset_ := offset_
    count_ := count_
...
packed_byte_array_packed_byte_array_bswap64 :: proc "contextless" (
    self: ^Packed_Byte_Array,
    offset_: Int,
    count_: Int,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("packed_byte_array_bswap64", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.Packed_Byte_Array, &_gde_name, 3638975848)
    }
    offset_ := offset_
    count_ := count_
