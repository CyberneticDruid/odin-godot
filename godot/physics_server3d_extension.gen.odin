...
physics_server3d_extension__soft_body_set_shrinking_factor :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(___soft_body_set_shrinking_factor_method_ptr, &self, raw_data(args), nil)
}
...
physics_server3d_extension__soft_body_get_shrinking_factor :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(___soft_body_get_shrinking_factor_method_ptr, &self, raw_data(args), &ret)
    return
}
...
physics_server3d_extension__soft_body_apply_point_impulse :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(___soft_body_apply_point_impulse_method_ptr, &self, raw_data(args), nil)
}
...
physics_server3d_extension__soft_body_apply_point_force :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(___soft_body_apply_point_force_method_ptr, &self, raw_data(args), nil)
}
...
physics_server3d_extension__soft_body_apply_central_impulse :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(___soft_body_apply_central_impulse_method_ptr, &self, raw_data(args), nil)
}
...
physics_server3d_extension__soft_body_apply_central_force :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(___soft_body_apply_central_force_method_ptr, &self, raw_data(args), nil)
}
...
physics_server3d_extension_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("_soft_body_set_shrinking_factor", true)
    ___soft_body_set_shrinking_factor_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1794382983)
    __name = new_string_name_cstring("_soft_body_get_shrinking_factor", true)
    ___soft_body_get_shrinking_factor_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 866169185)
    ...
    __name = new_string_name_cstring("_soft_body_apply_point_impulse", true)
    ___soft_body_apply_point_impulse_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 831953689)
    __name = new_string_name_cstring("_soft_body_apply_point_force", true)
    ___soft_body_apply_point_force_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 831953689)
    __name = new_string_name_cstring("_soft_body_apply_central_impulse", true)
    ___soft_body_apply_central_impulse_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3227306858)
    __name = new_string_name_cstring("_soft_body_apply_central_force", true)
    ___soft_body_apply_central_force_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3227306858)
...
@(private = "file")
___soft_body_set_shrinking_factor_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
___soft_body_get_shrinking_factor_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
___soft_body_apply_point_impulse_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
___soft_body_apply_point_force_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
___soft_body_apply_central_impulse_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
___soft_body_apply_central_force_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
