...
Resource_Deep_Duplicate_Mode :: enum {
...
resource_duplicate_deep :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__duplicate_deep_method_ptr, &self, raw_data(args), &ret)
    return
}
...
resource_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("duplicate_deep", true)
    __duplicate_deep_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 905779109)
...
@(private = "file")
__duplicate_deep_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
