...
rendering_server_mesh_surface_get_format_index_stride :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__mesh_surface_get_format_index_stride_method_ptr, &self, raw_data(args), &ret)
    return
}
...
rendering_server_mesh_surface_update_index_region :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__mesh_surface_update_index_region_method_ptr, &self, raw_data(args), nil)
}
...
rendering_server_environment_set_fog_depth :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__environment_set_fog_depth_method_ptr, &self, raw_data(args), nil)
}
...
rendering_server_instance_teleport :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__instance_teleport_method_ptr, &self, raw_data(args), nil)
}
...
rendering_server_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("mesh_surface_get_format_index_stride", true)
    __mesh_surface_get_format_index_stride_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3188363337)
    ...
    __name = new_string_name_cstring("mesh_surface_update_index_region", true)
    __mesh_surface_update_index_region_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2900195149)
    ...
    __name = new_string_name_cstring("environment_set_fog_depth", true)
    __environment_set_fog_depth_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 157498339)
    ...
    __name = new_string_name_cstring("instance_teleport", true)
    __instance_teleport_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2722037293)
...
@(private = "file")
__mesh_surface_get_format_index_stride_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__mesh_surface_update_index_region_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__environment_set_fog_depth_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__instance_teleport_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
