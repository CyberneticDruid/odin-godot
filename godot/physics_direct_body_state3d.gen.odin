...
physics_direct_body_state3d_set_collision_layer :: proc "contextless" (
    self: Physics_Direct_Body_State3d,
    layer_: Int,
) {
    self := self
...
physics_direct_body_state3d_get_collision_layer :: proc "contextless" (
    self: Physics_Direct_Body_State3d,
) -> (ret: u32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
physics_direct_body_state3d_set_collision_mask :: proc "contextless" (
    self: Physics_Direct_Body_State3d,
    mask_: Int,
) {
    self := self
...
physics_direct_body_state3d_get_collision_mask :: proc "contextless" (
    self: Physics_Direct_Body_State3d,
) -> (ret: u32) {
    self := self
    args := []__bindgen_gde.TypePtr {
