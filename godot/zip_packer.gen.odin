...
Zip_Packer_Compression_Level :: enum {
...
zip_packer_set_compression_level :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_compression_level_method_ptr, &self, raw_data(args), nil)
}
...
zip_packer_get_compression_level :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_compression_level_method_ptr, &self, raw_data(args), &ret)
    return
}
...
zip_packer_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_compression_level", true)
    __set_compression_level_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1286410249)
    __name = new_string_name_cstring("get_compression_level", true)
    __get_compression_level_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3905245786)
...
@(private = "file")
__set_compression_level_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_compression_level_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
