...
gltf_node_get_visible :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_visible_method_ptr, &self, raw_data(args), &ret)
    return
}
...
gltf_node_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("get_visible", true)
    __get_visible_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2240911060)
...
@(private = "file")
__get_visible_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
