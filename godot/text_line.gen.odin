...
text_line_init :: proc "contextless" () {
    ...
    __draw_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3625105422)
    __name = new_string_name_cstring("draw_outline", true)
    __draw_outline_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2592177763)
