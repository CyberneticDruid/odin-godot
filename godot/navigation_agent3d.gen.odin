...
navigation_agent3d_set_path_return_max_length :: proc "contextless" (
    self: Navigation_Agent3d,
    length_: f32,
) {
    self := self
...
navigation_agent3d_get_path_return_max_length :: proc "contextless" (
    self: Navigation_Agent3d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_agent3d_set_path_return_max_radius :: proc "contextless" (
    self: Navigation_Agent3d,
    radius_: f32,
) {
    self := self
...
navigation_agent3d_get_path_return_max_radius :: proc "contextless" (
    self: Navigation_Agent3d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_agent3d_set_path_search_max_polygons :: proc "contextless" (
    self: Navigation_Agent3d,
    max_polygons_: Int,
) {
    self := self
...
navigation_agent3d_get_path_search_max_polygons :: proc "contextless" (
    self: Navigation_Agent3d,
) -> (ret: i32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_agent3d_set_path_search_max_distance :: proc "contextless" (
    self: Navigation_Agent3d,
    distance_: f32,
) {
    self := self
...
navigation_agent3d_get_path_search_max_distance :: proc "contextless" (
    self: Navigation_Agent3d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_agent3d_get_path_length :: proc "contextless" (
    self: Navigation_Agent3d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
    }
    __bindgen_gde.object_method_bind_ptrcall(__get_path_length_method_ptr, &self, raw_data(args), &ret)
    return
}
...
navigation_agent3d_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("get_path_length", true)
    __get_path_length_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1740695150)
...
@(private = "file")
__get_path_length_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
