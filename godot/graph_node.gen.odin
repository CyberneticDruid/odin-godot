...
graph_node_set_slots_focus_mode :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_slots_focus_mode_method_ptr, &self, raw_data(args), nil)
}
...
graph_node_get_slots_focus_mode :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_slots_focus_mode_method_ptr, &self, raw_data(args), &ret)
    return
}
...
graph_node_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_slots_focus_mode", true)
    __set_slots_focus_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3232914922)
    __name = new_string_name_cstring("get_slots_focus_mode", true)
    __get_slots_focus_mode_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2132829277)
...
@(private = "file")
__set_slots_focus_mode_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_slots_focus_mode_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
