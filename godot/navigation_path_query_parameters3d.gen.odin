...
navigation_path_query_parameters3d_set_included_regions :: proc "contextless" (
    self: Navigation_Path_Query_Parameters3d,
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_included_regions_method_ptr, &self, raw_data(args), nil)
}

navigation_path_query_parameters3d_get_included_regions :: proc "contextless" (
    self: Navigation_Path_Query_Parameters3d,
) -> (ret: Typed_Array(Rid)) {
    self := self
    args := []__bindgen_gde.TypePtr {
    }
    __bindgen_gde.object_method_bind_ptrcall(__get_included_regions_method_ptr, &self, raw_data(args), &ret)
    return
}

navigation_path_query_parameters3d_set_excluded_regions :: proc "contextless" (
    self: Navigation_Path_Query_Parameters3d,
    regions_: Typed_Array(Rid),
) {
    self := self
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_excluded_regions_method_ptr, &self, raw_data(args), nil)
}

navigation_path_query_parameters3d_get_excluded_regions :: proc "contextless" (
    self: Navigation_Path_Query_Parameters3d,
) -> (ret: Typed_Array(Rid)) {
    self := self
    args := []__bindgen_gde.TypePtr {
    }
    __bindgen_gde.object_method_bind_ptrcall(__get_excluded_regions_method_ptr, &self, raw_data(args), &ret)
    return
}

navigation_path_query_parameters3d_set_path_return_max_length :: proc "contextless" (
    self: Navigation_Path_Query_Parameters3d,
    length_: f32,
) {
    self := self
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_path_return_max_length_method_ptr, &self, raw_data(args), nil)
}

navigation_path_query_parameters3d_get_path_return_max_length :: proc "contextless" (
    self: Navigation_Path_Query_Parameters3d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
    }
    __bindgen_gde.object_method_bind_ptrcall(__get_path_return_max_length_method_ptr, &self, raw_data(args), &ret)
    return
}

navigation_path_query_parameters3d_set_path_return_max_radius :: proc "contextless" (
    self: Navigation_Path_Query_Parameters3d,
    radius_: f32,
) {
    self := self
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_path_return_max_radius_method_ptr, &self, raw_data(args), nil)
}

navigation_path_query_parameters3d_get_path_return_max_radius :: proc "contextless" (
    self: Navigation_Path_Query_Parameters3d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
    }
    __bindgen_gde.object_method_bind_ptrcall(__get_path_return_max_radius_method_ptr, &self, raw_data(args), &ret)
    return
}

navigation_path_query_parameters3d_set_path_search_max_polygons :: proc "contextless" (
    self: Navigation_Path_Query_Parameters3d,
    max_polygons_: Int,
) {
    self := self
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_path_search_max_polygons_method_ptr, &self, raw_data(args), nil)
}

navigation_path_query_parameters3d_get_path_search_max_polygons :: proc "contextless" (
    self: Navigation_Path_Query_Parameters3d,
) -> (ret: i32) {
    self := self
    args := []__bindgen_gde.TypePtr {
    }
    __bindgen_gde.object_method_bind_ptrcall(__get_path_search_max_polygons_method_ptr, &self, raw_data(args), &ret)
    return
}

navigation_path_query_parameters3d_set_path_search_max_distance :: proc "contextless" (
    self: Navigation_Path_Query_Parameters3d,
    distance_: f32,
) {
    self := self
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_path_search_max_distance_method_ptr, &self, raw_data(args), nil)
}

navigation_path_query_parameters3d_get_path_search_max_distance :: proc "contextless" (
    self: Navigation_Path_Query_Parameters3d,
) -> (ret: f32) {
    self := self
    args := []__bindgen_gde.TypePtr {
    }
    __bindgen_gde.object_method_bind_ptrcall(__get_path_search_max_distance_method_ptr, &self, raw_data(args), &ret)
    return
}
...
navigation_path_query_parameters3d_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_included_regions", true)
    __set_included_regions_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 381264803)
    __name = new_string_name_cstring("get_included_regions", true)
    __get_included_regions_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3995934104)
    __name = new_string_name_cstring("set_excluded_regions", true)
    __set_excluded_regions_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 381264803)
    __name = new_string_name_cstring("get_excluded_regions", true)
    __get_excluded_regions_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3995934104)
    __name = new_string_name_cstring("set_path_return_max_length", true)
    __set_path_return_max_length_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 373806689)
    __name = new_string_name_cstring("get_path_return_max_length", true)
    __get_path_return_max_length_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1740695150)
    __name = new_string_name_cstring("set_path_return_max_radius", true)
    __set_path_return_max_radius_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 373806689)
    __name = new_string_name_cstring("get_path_return_max_radius", true)
    __get_path_return_max_radius_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1740695150)
    __name = new_string_name_cstring("set_path_search_max_polygons", true)
    __set_path_search_max_polygons_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1286410249)
    __name = new_string_name_cstring("get_path_search_max_polygons", true)
    __get_path_search_max_polygons_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3905245786)
    __name = new_string_name_cstring("set_path_search_max_distance", true)
    __set_path_search_max_distance_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 373806689)
    __name = new_string_name_cstring("get_path_search_max_distance", true)
    __get_path_search_max_distance_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1740695150)
}
...
@(private = "file")
__set_included_regions_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_included_regions_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__set_excluded_regions_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_excluded_regions_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__set_path_return_max_length_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_path_return_max_length_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__set_path_return_max_radius_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_path_return_max_radius_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__set_path_search_max_polygons_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_path_search_max_polygons_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__set_path_search_max_distance_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_path_search_max_distance_method_ptr: __bindgen_gde.MethodBindPtr