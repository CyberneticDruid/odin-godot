...
input_is_action_just_pressed_by_event :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__is_action_just_pressed_by_event_method_ptr, &self, raw_data(args), &ret)
    return
}
...
input_is_action_just_released_by_event :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__is_action_just_released_by_event_method_ptr, &self, raw_data(args), &ret)
    return
}
...
input_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("is_action_just_pressed_by_event", true)
    __is_action_just_pressed_by_event_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 551972873)
    __name = new_string_name_cstring("is_action_just_released_by_event", true)
    __is_action_just_released_by_event_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 551972873)
...
@(private = "file")
__is_action_just_pressed_by_event_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__is_action_just_released_by_event_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
