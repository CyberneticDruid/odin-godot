...
scene_state_get_base_scene_state :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_base_scene_state_method_ptr, &self, raw_data(args), &ret)
    return
}
...
scene_state_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("get_base_scene_state", true)
    __get_base_scene_state_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 3479783971)
...
@(private = "file")
__get_base_scene_state_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
