...
viewport_set_use_oversampling :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_use_oversampling_method_ptr, &self, raw_data(args), nil)
}
...
viewport_is_using_oversampling :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__is_using_oversampling_method_ptr, &self, raw_data(args), &ret)
    return
}
...
viewport_set_oversampling_override :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__set_oversampling_override_method_ptr, &self, raw_data(args), nil)
}
...
viewport_get_oversampling_override :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__get_oversampling_override_method_ptr, &self, raw_data(args), &ret)
    return
}
...
viewport_gui_get_drag_description :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__gui_get_drag_description_method_ptr, &self, raw_data(args), &ret)
    return
}
...
viewport_gui_set_drag_description :: proc "contextless" (
    ...
    __bindgen_gde.object_method_bind_ptrcall(__gui_set_drag_description_method_ptr, &self, raw_data(args), nil)
}
...
viewport_init :: proc "contextless" () {
    ...
    __name = new_string_name_cstring("set_use_oversampling", true)
    __set_use_oversampling_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 2586408642)
    __name = new_string_name_cstring("is_using_oversampling", true)
    __is_using_oversampling_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 36873697)
    __name = new_string_name_cstring("set_oversampling_override", true)
    __set_oversampling_override_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 373806689)
    __name = new_string_name_cstring("get_oversampling_override", true)
    __get_oversampling_override_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 1740695150)
    ...
    __name = new_string_name_cstring("gui_get_drag_description", true)
    __gui_get_drag_description_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 201670096)
    __name = new_string_name_cstring("gui_set_drag_description", true)
    __gui_set_drag_description_method_ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &__name, 83702148)
...
@(private = "file")
__set_use_oversampling_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__is_using_oversampling_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__set_oversampling_override_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__get_oversampling_override_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
...
@(private = "file")
__gui_get_drag_description_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
__gui_set_drag_description_method_ptr: __bindgen_gde.MethodBindPtr
@(private = "file")
